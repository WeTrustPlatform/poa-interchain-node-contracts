...
contract ExampleToken {
	...
	// See ERC20
	function balanceOf(address _owner) view constant external returns (uint256) {
	...
	// See ERC20
	function allowance(address _owner, address _spender) view constant external returns (uint256) {
